$(document).ready(function() {
  ...
  window.onload = function() {
    ...
    if (polar !== null) {
      window.myPolarArea = Chart.PolarArea(polar, config);
    }
  };
  /*=========================================
  Radar Chart
  ...
  /*=========================================
  Analytic - User Acquisition
  ===========================================*/
 
  var acquisition1 = document.getElementById("acquisition1");
  if (acquisition1 !== null) {
    var acChart1 = new Chart(acquisition1, {
      // The type of chart we want to create
      type: "line",
    ...
    document.getElementById(
      "customLegend1"
    ).innerHTML = acChart1.generateLegend();
  }
  var acquisition2 = document.getElementById("acquisition2");
  if (acquisition2 !== null) {
    var acChart2 = new Chart(acquisition2, {
      // The type of chart we want to create
      type: "line",
    ...
    document.getElementById(
      "customLegend2"
    ).innerHTML = acChart2.generateLegend();
  }
  var acquisition3 = document.getElementById("acquisition3");
  if (acquisition3 !== null) {
    ...
    document.getElementById(
      "customLegend3"
    ).innerHTML = acChart3.generateLegend();
  }
  /*=========================================
  ...
  if (activity !== null) {
    var actChart = new Chart(activity, {
      // The type of chart we want to create
      type: "line",
      // The data for our dataset
      data: {
  ...
  if (activity2 !== null) {
    var actChart = new Chart(activity2, {
      // The type of chart we want to create
      type: "line",
      // The data for our dataset
      data: {
  ...
  if (activity3 !== null) {
    var actChart = new Chart(activity3, {
      // The type of chart we want to create
      type: "line",
      // The data for our dataset
      data: {
  ...
  if (activity4 !== null) {
    var actChart = new Chart(activity4, {
      // The type of chart we want to create
      type: "line",
      // The data for our dataset
      data: {
        ...
        datasets: [
          {
            ...
            data: [23800, 23800, 23800],
            backgroundColor: "#4c84ff",
            borderWidth: 1,
            // borderColor: ['#4c84ff','#29cc97','#8061ef','#fec402']
            hoverBBackgroundColor: "#29cc97"
          }
        ]
      },
      options: {
...
/*=========================================
	gradient Line Chart
	===========================================*/
var gline = document.getElementById("gline1");
if (gline !== null) {
  gline = gline.getContext("2d");
  var gradientFill = gline.createLinearGradient(0, 120, 0, 0);
  gradientFill.addColorStop(0, "rgba(41,204,151,0.10196)");
  gradientFill.addColorStop(1, "rgba(41,204,151,0.30196)");

  var lChart = new Chart(gline, {
    type: "line",
    data: {
      labels: ["Fri", "Sat", "Sun", "Mon", "Tue", "Wed", "Thu"],
      datasets: [
